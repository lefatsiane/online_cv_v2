...
const EmailSection = () => {
  ...
  return (
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4  relative">
      <div className="bg-[radial-gradient(ellipse-at-center,_var(--tw-gradient-stops))] bg-orange-900 to-transparent rounded-full h-80 w-80 z-1 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-y-1/2 -z-9  "></div>
      <div>
        {" "}
        ...
        <p className="text-slate-300 mb-4 max-w-md z-10  ">
          ...
          possimus nisi eius tempore maiores inventore iure neque quos
          blanditiis expedita, incidunt temporibus dicta aliquid. Minus iste
          sint dolorum necessitatibus.
        </p>
